...
Escribe un programa que pide al usuario que ingrese números positivos. Tomando en cuenta lo siguiente:
\begin{itemize}
    \item Usar un ciclo while.
    \item Sumar solo los números mayores a 10.
    \item Contar cuantos números cumplen esta condición.
    \item El ciclo termina cuando el usuario ingresa un número negativo.
    \item Muestra la suma (de los mayores a 10) y su cantidad (cuántos numeros fueron mayores a 10).
\end{itemize}
