...
\begin{frame}{Los Cinco Componentes Principales}
 ...
 \begin{figure}
                \centering
                \includegraphics[width=0.7\linewidth]{Figuras/Cap0/fig0-2.png}
...
\begin{frame}{Flujo de Datos y la CPU}
 ...
 \begin{figure}
                \centering
                \includegraphics[width=0.35\linewidth]{Figuras/Cap0/fig0-3.png}
 ...
 \begin{figure}
                \centering
                \includegraphics[width=0.7\linewidth]{Figuras/Cap0/motherboard.jpg}
                \label{fig:ucp_detalle}
            \end{figure}
            \end{frame}
        ...
        \column{.48\textwidth}
            \begin{block}{Memoria de Acceso Aleatorio (RAM)}
                \begin{itemize}
                    ...
                    \item Su principal característica es la alta velocidad de acceso.
                \end{itemize}
            \end{block}
